...
const seeds: Record<string, LessonSeed[]> = {
  aqeedah: [
    ...
    { slug: "allah-sees-hears", title: "الله يرى ويسمع", focus: "الله السميع البصير يراقب أحبابه برعاية وحنان لا برقابة مخيفة. هذا الدرس يبني في الطفل إحساساً عميقاً بأن الله معه دائماً يحبه ويحفظه في كل لحظة. نستخدم أمثلة من اليوم كلمح الأم لطفلها من بُعد ورعاية الله التي هي أعظم وأدوم.", activity: "ارسموا معاً يداً حانية وكتبوا بجانبها: الله يراني ويحبني.", ageRange: "6-9 سنوات", readingTime: "7 دقائق" },
  ...
  akhlaq: [
    ...
    { slug: "generosity-small", title: "الكرم الصغير", focus: "الكرم لا يشترط مالاً كثيراً فكلمة تشجيع أو وقت منحوه أو شيء محبوب مشاركه كرمٌ حقيقي. الطفل الذي يتعلم الكرم الصغير يكبر على قلب سخي. الدرس يفتح عيون الطفل على الفرص اليومية للعطاء.", activity: "يختار الطفل شيئاً يحبه ويشاركه مع أخ أو صديق اليوم.", ageRange: "6-10 سنوات", readingTime: "6 دقائق" },
