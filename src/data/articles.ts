...
const articleRows = [
  ["ماذا أفعل بعد الباك في المغرب؟", "madha-afal-baad-al-bac-fi-almaghrib", "بعد الباك", "دليل مبسط لفهم اختيارات ما بعد الباك في المغرب دون تشتت أو قرارات متسرعة."],
  ["كيف أختار التخصص المناسب؟", "kaifa-akhtar-altakhasos-almonasib", "اختيار التخصص", "طريقة عملية لمقارنة التخصصات حسب الميول، القدرات، المدينة، وسوق العمل."],
  ["الفرق بين الجامعة والمدرسة العليا", "alfarq-bayna-aljamiha-walmadrasa-alolya", "بعد الباك", "مقارنة هادئة بين الدراسة في الجامعة والمدارس العليا من حيث الأسلوب والانتقاء والمرونة."],
  ["هل التكوين المهني اختيار جيد؟", "hal-altakwin-almihani-ikhtiyar-jayyid", "التكوين المهني", "متى يكون التكوين المهني اختياراً ذكياً؟ وكيف تقارنه بباقي المسارات؟"],
  ["كيف أكتب رسالة تحفيزية؟", "kaifa-aktob-risala-tahfiziya", "المنح والملفات", "خطوات كتابة رسالة تحفيزية واضحة وصادقة للدراسة أو المنح أو المباريات."],
  ["كيف أستعد لمباراة ولوج مدرسة؟", "kaifa-astahid-limobarat-woloj-madrasa", "المباريات", "خطة استعداد عملية تبدأ من قراءة الإعلان الرسمي وتنتهي بتنظيم المراجعة."],
  ["أفضل مهارات رقمية للطلبة", "afdal-maharat-raqmiya-liltolaba", "المهارات الرقمية", "مهارات رقمية يمكن أن تدعم أي طالب: البرمجة، التسويق، التصميم، البيانات، والذكاء الاصطناعي."],
  ["كيف أختار مدينة الدراسة؟", "kaifa-akhtar-madinat-addirasa", "الحياة الطلابية", "معايير اختيار مدينة الدراسة: السكن، النقل، القرب من العائلة، والفرص."],
  ...
  ["أخطاء شائعة في اختيار التخصص", "akhtaa-shaia-fi-ikhtiyar-altakhasos", "اختيار التخصص", "أخطاء يقع فيها كثير من الطلبة عند اختيار التخصص وكيف تتجنبها."],
  ...
  ["كيف أتعرف على ميولي الدراسية؟", "kaifa-ataaraf-ala-moyoli-addirasiya", "التوجيه", "الميول لا تظهر من اختبار واحد فقط؛ تعرف عليها عبر التجربة والملاحظة والأسئلة الصحيحة."],
];
...
export const articles: Article[] = articleRows.map(([title, slug, category, excerpt], index) => ({
  ...
  internalLinks: [
    { label: "دليل التوجيه", href: "/orientation" },
    { label: "اختيارات ما بعد الباك", href: "/after-bac" },
    { label: "المسارات المهنية", href: "/careers" },
    { label: "موارد عملية", href: "/resources" },
  ],
})) as Article[];
